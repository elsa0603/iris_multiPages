...
st.title("IRIS 品種預測")
#載入模型
svm = joblib.load("joblib/svm_model.joblib")
knn = joblib.load("joblib/KNN_model.joblib")
lr = joblib.load("joblib/LR_model.joblib")
rf = joblib.load("joblib/RF_model.joblib")
